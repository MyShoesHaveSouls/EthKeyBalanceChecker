...
ETHERSCAN_API_KEYS = [
    '5K221ME7PYP5RUE1E1CBCB8WU2UV3EMKDS',  # Replace with your actual API key 1
    'YQQVKPQFWG7X2NU67549KEEH2RMVJS3KCPW',  # Replace with your actual API key 2
    'JPPXZJ51MRYMKWBXMPCU266M6DNK8J5MXR'   # Replace with your actual API key 3
]
...
def generate_address_from_private_key(private_key):
    # Use the Ethereum Account library to derive the address
